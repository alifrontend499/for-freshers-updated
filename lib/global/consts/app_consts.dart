...
String APP_CONST_DIALOG_PREMIUM_TEST_DESCRIPTION = "A premium account is required to access this test";
...
String APP_CONST_DIALOG_START_TEST_OVER_DESCRIPTION = "You have already completed this test. Starting over will remove all the previous progress.";
...
String APP_CONST_DIALOG_CANCEL_TEST_DESCRIPTION = "Are you sure you want to cancel? All your progress will be lost.";
...
String APP_CONST_VALIDATION_ERROR_VALID_CONFIRM_PASSWORD = "Confirm password should be same as the password";
String APP_CONST_VALIDATION_ERROR_6_CHARACTERS_LONG = "The value should be atleast 6 characters long";
...
const String APP_CONST_AUTH_RESPONSE_SIGNUP_SUCCESS = "User create successful. please login";
const String APP_CONST_AUTH_RESPONSE_LOGIN_SUCCESS = "Login successful";
const String APP_CONST_AUTH_RESPONSE_PASSWORD_CHANGED_SUCCESS = "Password changed successfully";
const String APP_CONST_AUTH_RESPONSE_PROFILE_EDIT_SUCCESS = "Profile updated successfully";
