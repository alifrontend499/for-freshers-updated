...
class StartingTestOverDialog extends StatelessWidget {
  ...
  const StartingTestOverDialog({Key? key, required this.testId}) : super(key: key);
    ...
    return SimpleDialog(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Text(
              APP_CONST_DIALOG_START_TEST_OVER_HEADING,
        ...
        // child | description
        Text(
          APP_CONST_DIALOG_START_TEST_OVER_DESCRIPTION,
        ...
        ElevatedButton(
          ...
          child: Text(APP_CONST_DIALOG_START_TEST_OVER_BTN_START_NOW),
        ),
          ...
          children: [
            InkWell(
              ...
              child: Padding(
                ...
                child: Text(
                  APP_CONST_DIALOG_START_TEST_OVER_TEXT_CANCEL,
